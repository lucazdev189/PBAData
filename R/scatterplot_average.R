...
#' @param linear_regression Adds a linear regression line. Set to FALSE on default.
#' @param lregression_method Method used to do the linear regression line. Set to lm on default
